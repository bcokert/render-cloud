...
func TestSphereJsonEncodes(t *testing.T) {
	sphere := model.Sphere{Origin: vector.Vector3{0, 0, 0}, Radius: 5.0, Color: colorful.Color{R: 1, G: 0, B: 0}, Shininess: 9}
...
func TestSpheresJsonEncodes(t *testing.T) {
	spheres := model.Spheres{
		model.Sphere{Origin: vector.Vector3{0, 0, 0}, Radius: 5.0, Color: colorful.Color{R: 1, G: 0, B: 0}, Shininess: 1},
		model.Sphere{Origin: vector.Vector3{600, 100, 0}, Radius: 7.0, Color: colorful.Color{R: 0, G: 1, B: 0}, Shininess: 4},
		model.Sphere{Origin: vector.Vector3{300, 400, 0}, Radius: 1.5, Color: colorful.Color{R: 0, G: 0, B: 1}, Shininess: 1.23},
	}
